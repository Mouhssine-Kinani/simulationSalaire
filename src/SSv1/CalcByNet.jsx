...
function CalcByNet() {
  ...
  // Fonction pour formater l'entrée utilisateur (remplacement de la virgule par un point)
  ...
  // Fonction de calcul basée sur le salaire de base
  const calcule = (baseSalary) => {
    const salaireDB = parseFloat(baseSalary) || 0;
    ...
    // Salaire par jour
    const salaireParJour = CoutTotal / 20;
    ...
    return {
      ...
      salaireParJour: salaireParJour.toFixed(2),
    };
  };

  // Recherche du salaire de base correspondant au net souhaité
  // en utilisant une méthode de dichotomie (binary search)
  const rechercheSalaireBase = (netSouhaite) => {
    ...
    setResult({ error: "Aucun salaire de base trouvé pour ce net !" });
  };
            ...
            <table className="w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr className="bg-gray-100">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {result.totalCotisationSalariales} MAD
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
