...
function CalcByNet() {
  ...
  // Format number: accepts 9200, 9200.00, 9200,00, etc.
  ...
  // Fonction de calcul intégrant la dynamique de l'IR
  const calcule = (salaireDeBase) => {
    ...
    const autresIndemnites =
      conge + licenciement + dommageEtInteret + preavis;
